      ...
      <div className="pointer-events-none absolute inset-0 z-0 select-none">
        ...
        <div
          style={{
            ...
            height: 720,
            borderRadius: "50%",
            background: `radial-gradient(circle, rgba(0,112,243,${op}) 0%, transparent 68%)`,
            filter: "blur(72px)",
        ...
        <div
          style={{
            ...
            height: 640,
            borderRadius: "50%",
            background: `radial-gradient(circle, rgba(124,58,237,${op * 0.85}) 0%, transparent 70%)`,
            filter: "blur(80px)",
        ...
        <div
          style={{
            ...
            height: 440,
            borderRadius: "50%",
            background: `radial-gradient(circle, rgba(6,182,212,${op * 0.6}) 0%, transparent 70%)`,
            filter: "blur(64px)",
