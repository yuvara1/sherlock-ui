...
function AuthInput({
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
      ...
      >
        {label}
        {required && <span style={{ color: "#3291ff", marginLeft: 2 }}>*</span>}
      </label>
          ...
          >
            ...
            <div
              style={{
                ...
                overflow: "hidden",
                background:
                  "linear-gradient(135deg, rgba(0,112,243,0.12) 0%, rgba(124,58,237,0.08) 100%)",
                border: "1px solid rgba(255,255,255,0.07)",
                padding: "32px 28px",
              }}
            >
              ...
              <div
                style={{
                  ...
                  overflow: "hidden",
                  background:
                    "linear-gradient(180deg, #0a1a2e 0%, #0d2b1e 40%, #1a3a20 70%, #2d5a28 100%)",
                  position: "relative",
                }}
              >
            ...
            >
              ...
              >
                ...
                <span style={{ color: "#3dd68c", fontWeight: 600 }}>
                  under 4 hours
                </span>
              </p>
            </div>
